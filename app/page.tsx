...
const basePath = '/cnno-1776323818645';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'OG Rolls: Our original sweet rolls are a classic for a reason. Soft, fluffy, and full of sweetness, they\'re the perfect treat to brighten up your day.', icon: 'domain' }, { n: 'Product 2', d: 'Pistachio Rolls: For a twist on our classic OG Rolls, try our Pistachio Rolls, infused with the nutty flavor of pistachios for a unique and delicious experience.', icon: 'architecture' }, { n: 'Product 3', d: 'Chocolate Rolls: Indulge in the richness of our Chocolate Rolls, filled with decadent chocolate and wrapped in our signature soft dough, perfect for satisfying any chocolate craving.', icon: 'chair' }, { n: 'Product 4', d: 'Baby Rolls: Our Baby Rolls are the perfect bite-sized treat, offering all the sweetness of our larger rolls in a cute and convenient package, ideal for snacking on the go.', icon: 'eco' }, { n: 'Product 5', d: 'Party Box: Whether you\'re celebrating a special occasion or just want to share the joy of CNNO with friends and family, our Party Box is the perfect solution, filled with an assortment of our delicious rolls.', icon: 'precision_manufacturing' }];
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To craft mouthwatering sweet rolls that not only satisfy your taste buds but also warm your soul, one roll at a time.</p></div>
